...
{% set stg_tmp_relation = ref('stg_amazon_ads__targeting_keyword_report_tmp') %}
...
select
    {{ amazon_ads.standardize_column_names(
        ...
        table_name='targeting_keyword_report',
        base_columns=get_targeting_keyword_report_columns())
        }}
