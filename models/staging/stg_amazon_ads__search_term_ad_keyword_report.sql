...
{% set stg_tmp_relation = ref('stg_amazon_ads__search_term_ad_keyword_report_tmp') %}
...
select
    {{ amazon_ads.standardize_column_names(
        ...
        table_name='search_term_ad_keyword_report',
        base_columns=get_search_term_ad_keyword_report_columns())
        }}
