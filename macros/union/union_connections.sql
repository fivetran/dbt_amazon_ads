{% macro amazon_ads_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}

{{ adapter.dispatch('amazon_ads_union_connections', 'amazon_ads') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__amazon_ads_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}
...
{# For unioning #}
    ...
    {%- if relations != [] -%}
        {{ amazon_ads.amazon_ads_union_relations(relations) }}
